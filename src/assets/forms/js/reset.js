(function () {
  ...
  function resetChecklist() {
    ...
    if (VC.els.client) {
      VC.els.client.value = '';
      VC.els.client.classList && VC.els.client.classList.remove('is-invalid');
    }
    if (VC.els.reviewer) {
      VC.els.reviewer.value = '';
      VC.els.reviewer.classList && VC.els.reviewer.classList.remove('is-invalid');
    }
