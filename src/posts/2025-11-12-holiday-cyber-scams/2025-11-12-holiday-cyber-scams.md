...
- [#x] **MFA Everywhere:** Enable Multi-Factor Authentication on your email, bank accounts, and primary social media.
- [#x] **Unique Passwords:** Stop reusing passwords. Start using a password manager today.
- [#x] **No Shopping at Work:** Avoid using work devices or the corporate network for personal holiday shopping, as this can introduce risks into your employer's systems.
- [#x] **Verify Links:** Get in the habit of hovering over links before clicking. Look for spelling errors or strange domains in email addresses.
- [#x] **Update Everything:** Make sure your phone, computer, and all applications have the latest security patches and updates installed.
